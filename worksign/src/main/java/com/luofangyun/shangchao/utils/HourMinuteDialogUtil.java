 ...
 * @author
 */
public class HourMinuteDialogUtil implements OnDateChangedListener,
	 ...
	 */
	public HourMinuteDialogUtil(Activity activity, String initDateTime) {
	...
	public AlertDialog dateTimePicKDialog(final EditText inputDate) {
		...
		timePicker = (TimePicker) dateTimeLayout.findViewById(R.id.timepicker1);
		init(timePicker);
