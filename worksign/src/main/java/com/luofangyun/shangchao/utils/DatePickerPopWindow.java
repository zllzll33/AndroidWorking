...
import com.luofangyun.shangchao.utils.wheelview.OnWheelScrollListener;
import com.luofangyun.shangchao.utils.wheelview.WheelView;
import com.luofangyun.shangchao.utils.wheelview.adapter.NumericWheelAdapter;
...
public class DatePickerPopWindow extends PopupWindow{
	...
	public static TextView wheelConfirm;
	public static TextView wheelCancle;
	...
	private void initWindow() {
		...
		wheelConfirm = (TextView) dateView.findViewById(R.id.wheel_confirm);
		wheelCancle = (TextView) dateView.findViewById(R.id.wheel_cancle);
	...
	OnWheelScrollListener scrollListener = new OnWheelScrollListener() {
		...
		public void onScrollingFinished(WheelView wheel) {
			wheelConfirm.setOnClickListener(new View.OnClickListener() {
				@Override
			...
			wheelCancle.setOnClickListener(new View.OnClickListener() {
				@Override
				public void onClick(View v) {
