 ...
 * 企业部门
 */
public class CorporBranchActivity extends BaseActivity {
    private View         view;
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(getApplication(), AddEmplActivity.class);
                    intent.putExtra("deptName", dataList.get(getPosition()).deptname);
                    intent.putExtra("deptCode", dataList.get(getPosition()).deptcode);
